...
public class CambiarDetalle extends Activity {
            ...
            dialogo1.setPositiveButton("Confirmar", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialogo1, int id) {
                    ...
                    if (parametro.trim().equals("TECNICO")) {
                        ...
                        params1.add(new BasicNameValuePair("sCodEmpresa", empresa.trim()));
                        params1.add(new BasicNameValuePair("sCodSucursal", sucursal.trim()));
                        params1.add(new BasicNameValuePair("sUbicacion", lavador.getText().toString()));
                        params1.add(new BasicNameValuePair("sParametro", "ubicacion"));
                        ...
                        try {
                            ...
                            Toast.makeText(CambiarDetalle.this, "Ya hay un carro en esta ubicacion !", Toast.LENGTH_SHORT).show();
                            ...
                            params4.add(new BasicNameValuePair("sCodEmpresa", empresa.trim()));
                            params4.add(new BasicNameValuePair("sCodSucursal", sucursal.trim()));
                            params4.add(new BasicNameValuePair("sCodPlaca", cod_placa.trim()));
                            params4.add(new BasicNameValuePair("sNumRombo", num_rombo.trim()));
                            params4.add(new BasicNameValuePair("sParametro", "ubicacionPantalla"));
                            ...
                            params3.add(new BasicNameValuePair("sCodSucursal", sucursal.trim()));
                            params3.add(new BasicNameValuePair("sUbicacion", array.get(0)));
                            params3.add(new BasicNameValuePair("sParametro", "apagarPantalla"));
    ...
    public void buscarLavador(View v){
        ...
        if (parametro.equals("U")){
            ...
            bundle2.putString("atributo", "UBICACIONDMS");
            ...
            if (parametro.equals("T")){
                ...
                bundle2.putString("conexion", conexion);
                bundle2.putString("ip", ip);
                bundle2.putString("atributo", "TECNICODMS");
                bundle2.putString("empresa", empresa);
                bundle2.putString("sucursal", sucursal);
                intent.putExtras(bundle2);
                CambiarDetalle.this.startActivityForResult(intent, 1);
